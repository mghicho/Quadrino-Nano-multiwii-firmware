...
/*************************************************************************************************/
  ...
  /***********************      your individual defaults     ***********************/
     ...
     */
    //#define MY_PRIVATE_DEFAULTS "defaults.h"
...
/*************************************************************************************************/
  ...
  /***********************             HW PWM Servos             ***********************/ 
    ...
    // Warning: Quadrino Nano: using this feature moves the function of pin D2 on the Motor cable 
...
// QUADRINO SETTINGS
// The following values are part of the Firmware Config Tool (FCT) settings and do not affect MultiWii.
// Changing these values will only affect the firmware if compiling using the FCT.
#define QUADRINO_MODEL      Nano
#define QUADRINO_VERSION    V1
// AGRESSION: A number between -70 and +30 where 0 is typical, negative is more subdued and positive is more acrobatic.
#define QUADRINO_AGGRESSION    0
// ANTIWOBBLE: Increase this value up to 50 to reduce wobble or oscillation during maneuvers. It essentially reduces the I term of the PIDs.
#define QUADRINO_ANTIWOBBLE    0
// ARMLENGTH: the arm length from motor-to-motor, always expressed in millimeters regardless of the UNIT parameter below.
// ARMLENGTH_UNIT: In what units to display the arm length, either MM or IN.
#define QUADRINO_ARMLENGTH    450
#define QUADRINO_ARMLENGTH_UNIT    MM
// ASPECT: a number between -50 and +50 that adjusts the roll/pitch. Less than 0 is longer roll axis, Greater than 0 is longer pitch axis.
#define QUADRINO_ASPECT    0
